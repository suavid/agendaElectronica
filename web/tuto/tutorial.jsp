...
<div class="unico">
    <div id="first" class="details">
        <p class="summary">¿Donde veo mis datos?,¿Los puedo modificar?</p>
        <p>
            <br />
    ...
    <div class="details">
        <p class="summary">¿Cómo agregar nuevo contacto?</p>
        <p>
            <br />
    ...
    <div class="details">
        <p class="summary">¿C&oacute;mo buscar un contacto existente</p>
        <p>
          <br />
    ...
    <div class="details">
        <p class="summary">¿Cómo modificar un contacto?</p>
        <p>
            <br />
    ...
    <div class="details">
        <p class="summary">¿Cómo eliminar un contacto?</p>
        <p>
             <br />
...
<%
    ...
    if (tu.equals("Administrador"))
    {
        %>
        <div class="details">
            <p class="summary">¿C&oacute;mo administrar los usuarios del sistema?</p>
            <p><br />
            ...
            <a  class="link" href="../usuarios/MostrarUsuarios.jsp"> -> Administrar Usuarios </a></p>
